...
export default function Home() {
  ...
  const navLinks = [
    ...
    { label: "Projects", to: "projects", scroll: true },
    { label: "Community", to: "community", scroll: true },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <main>
        ...
        >
          <div className="absolute top-20 right-0 w-[500px] h-[500px] bg-primary/10 rounded-full blur-[100px] -z-10" aria-hidden="true" />
          <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-blue-500/10 rounded-full blur-[80px] -z-10" aria-hidden="true" />
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <h1 className="text-5xl md:text-7xl font-bold leading-[1.1] mb-6" style={{ fontFamily: "var(--font-display)" }}>
                  Hi, I'm <br />
                ...
                <p className="text-xl text-muted-foreground leading-relaxed mb-4 max-w-lg">
                  Full Stack Developer building products from idea to launch.
                  I turn real problems into real software — clean, functional,
                  and built to matter.
                </p>
                <p className="text-base text-muted-foreground leading-relaxed mb-8 max-w-lg">
                  ...
                  <span className="text-foreground font-medium">Latinas in Tech</span>.
                </p>
              ...
              >
                <div className="relative w-72 h-72 md:w-96 md:h-96">
                  {/* Decorative rings — intentional in both light and dark */}
                  <motion.div
                  ...
                  <motion.div
                    ...
                    aria-hidden="true"
                  />
                  {/* Glow ring so it reads in dark mode too */}
                  <div
            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-8 md:gap-16">
                {skills.map((skill) => (
                  ...
                  >
                    <skill.icon className="w-8 h-8 text-muted-foreground group-hover:text-primary transition-colors duration-300" aria-hidden="true" />
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="space-y-5 text-muted-foreground leading-relaxed text-base">
                  <p>
                    I'm a Full Stack Developer based in Boston who genuinely loves
                    building software. Not just writing it — building it. Taking
                    something from a rough idea, figuring out the right architecture,
                    and shipping something real that people actually use.
                  </p>
                  <p>
                    My background spans full-stack web development, backend APIs,
                    and database design. I've also worked on AI-powered applications —
                    including document understanding tools that help people interact
                    with information in smarter ways. I enjoy environments where I
                    can wear multiple hats and move fast.
                  </p>
                  <p>
                    Startup culture fits me well. I thrive when there's ambiguity to
                    navigate, problems to solve creatively, and a team that cares about
                    what they're building. I've collaborated with founders, designers,
                    and engineers across early-stage projects where the work actually
                    shapes the product.
                  </p>
                  <p>
                    Outside of code, I lead the Boston chapter of{" "}
                    <span className="text-foreground font-semibold">Latinas in Tech</span>{" "}
                    and stay involved with{" "}
                    <span className="text-foreground font-semibold">Resilient Coders</span>,
                    a nonprofit expanding access to software engineering careers. I
                    mentor early-career engineers and show up for the Boston tech
                    community because I believe who gets to build technology matters
                    just as much as what gets built.
                  </p>
              ...
              >
                {[
                  ...
                  { icon: Users, label: "Community", value: "Latinas in Tech" },
                  { icon: Heart, label: "Passion", value: "Meaningful software" },
                ].map((item) => (
                  <div
                    key={item.label}
        ...
        {/* ── Community Impact ── */}
        <section id="community" aria-labelledby="community-heading" className="py-24 bg-secondary/30">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-16">
              <h2
              ...
              {communityCards.map((card, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center text-primary flex-shrink-0 group-hover:bg-primary/20 transition-colors" aria-hidden="true">
        ...
        <section id="contact" aria-labelledby="contact-heading" className="py-24 relative">
          <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-primary/5 rounded-full blur-[120px] -z-10" aria-hidden="true" />
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid md:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-base text-muted-foreground mb-10 leading-relaxed">
                  I'm open to software engineering roles, startup collaborations,
                  technical consulting, community speaking, and honest coffee chats
                  with people doing interesting work.
                </p>
                ...
                <div className="space-y-5">
                  {[
                    ...
                    { icon: Users, label: "Community", value: "Latinas in Tech · Resilient Coders" },
                  ].map((item) => (
                    <div key={item.label} className="flex items-center gap-4">
                      <div className="w-11 h-11 rounded-full bg-primary/10 flex items-center justify-center text-primary flex-shrink-0" aria-hidden="true">
